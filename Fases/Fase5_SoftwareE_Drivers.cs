...
namespace INSTALADOR_SOFTWARE_SE.Fases
{
    ...
    public class Fase5_SoftwareE_Drivers
    {
        ...
        private void VerificarEInstalarDrivers()
        {
            ...
            string scriptPath = Path.Combine(INSTALADOR_SOFTWARE_SE.AppConfig.DeploymentSharePath, "Scripts", "Test-DriverStatus.ps1");
            ...
            if (exitCode == 1) // Código '1' que definimos para "problemas encontrados"
            {
                ...
                string scriptLenovoPath = Path.Combine(INSTALADOR_SOFTWARE_SE.AppConfig.DeploymentSharePath, "Scripts", "Invoke-LenovoSystemUpdate.ps1");
